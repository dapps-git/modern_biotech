    ...
    <section id="training" className="section">
      <div className="container">
        ...
        <div className={styles.grid}>
          {/* Left Column: List of Training Cards */}
            ...
            {programs.map((prog) => (
              <div key={prog.id} className={`card ${styles.programCard}`}>
                <div className={styles.programHeader}>
                  ...
                  <div>
                    <h3 className="h3-heading">{prog.title}</h3>
                    <span className={styles.programSub}>{prog.subTitle}</span>
                  </div>
                </div>
                <p className="body-text" style={{ margin: "1rem 0 1.5rem 0" }}>
                  {prog.description}
                </p>
                <button
          ...
          {/* Right Column: Internship and Intern Showcase */}
          <div className={styles.internShowcase}>
            <div className={styles.internCard}>
              ...
              <div className={styles.internContent}>
                <div className="badge badge-gold" style={{ marginBottom: "0.75rem", alignSelf: "flex-start" }}>
                  ★ Hands-on Internships
                </div>
                <h3 className="h3-heading" style={{ color: "var(--primary-blue)", marginBottom: "0.55rem" }}>
              ...
              <div className={styles.syllabusList}>
                {activeProgram.syllabus.map((item, index) => (
                  <div key={index} className={styles.syllabusItem}>
                    ...
                    <p className="body-text" style={{ fontWeight: 600, color: "var(--neutral-dark)" }}>
                      {item}
                    </p>
                  </div>
                ))}
